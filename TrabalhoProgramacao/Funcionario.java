...
public class Funcionario extends Pessoa {
	...
	public static void saveFuncionario() {
		...
		if (Global.funcionario.size() != 0) {
			...
			Funcionario funcionario1 = new Funcionario(1, "Aline Athaydes", "14/05/1995", "Ap #339-1801 Ornare Ave",
					"1-654-884-6326", "erat.eget@hotmail.com");
			func.add(funcionario1);
			Funcionario funcionario2 = new Funcionario(2, "Bianca Santos", "11/04/1998", "Ap #741-8033 Eu Avenue",
					"(121) 635-4780", "sem@outlook.net");
			func.add(funcionario2);
			Funcionario funcionario3 = new Funcionario(3, "Francine Solon", "11/10/1995", "Ap #769-4451 Eu Road",
					"1-443-237-1017", "purus@outlook.edu");
			func.add(funcionario3);
			Funcionario funcionario4 = new Funcionario(4, "Raquel Silva", "19/12/2000", "257-3408 Rhoncus. Av.",
					"1-648-835-8767", "ut.mi.duis@outlook.net");
			func.add(funcionario4);
			Funcionario funcionario5 = new Funcionario(5, "Marcos Vinicius", "06/08/2006",
					"P.O. Box 327, 8651 Tincidunt St.", "(265) 546-6263", "metus.aenean@google.net");
			func.add(funcionario5);
			Funcionario funcionario6 = new Funcionario(6, "Sarah Chagas", "25/07/2005", "Ap #821-4102 Sed Av.",
					"1-617-738-6987", "elit.erat.vitae@icloud.org");
			func.add(funcionario6);
			Funcionario funcionario7 = new Funcionario(7, "Thiago Dotto", "28/10/1980", "Ap #821-4102 Sed Av.",
					"(532) 622-2182", "luctus.ipsum@google.com");
	...
	public static void atualizarFuncionario() {
		...
		if (idExistente) {
			Funcionario f1 = (Funcionario) Global.funcionario.get(idsc);
			System.out.format("%-15s%-15s%-15s%-15s%-15s%-15s\n", f1.getId(), f1.getNome(), f1.getDataNascimento(),
					f1.getEndereco(), f1.getTelefone(), f1.getEmail());
			System.out.println(" ");
			System.out.println("Deseja realmente atualizar esse Funcionário? Se sim Digite 1");
			...
			if(atualizar==1) {
				...
				Global.funcionario.set(idsc, f1);
	...
	public static void listarFuncionario() {
		...
		System.out.format("%-15s%-15s%-15s%-15s%-15s%-15s\n", " Id ", " Nome ", " Data de Nasc ", " Endereço ",
				" Telefone ", " E-mail ");
		for (int i = 0; i < Global.funcionario.size(); i++) {
			Funcionario f1 = (Funcionario) Global.funcionario.get(i);
			// System.out.println(f1.getId() +"\t"+
			// f1.getNome()+"\t"+f1.getDataNascimento()+"\t"+ f1.getEndereco()+"\t"+
			// f1.getTelefone()+"\t"+ f1.getEmail());
			System.out.format("%-15s%-15s%-15s%-15s%-15s%-15s\n", f1.getId(), f1.getNome(), f1.getDataNascimento(),
					f1.getEndereco(), f1.getTelefone(), f1.getEmail());
	...
	public static void deletarFuncionario() {
		...
		if (idExistente) {
			...
			System.out.format("%-15s%-15s%-15s%-15s%-15s%-15s\n", f1.getId(), f1.getNome(), f1.getDataNascimento(),
					f1.getEndereco(), f1.getTelefone(), f1.getEmail());
			System.out.println(" ");
			System.out.println("Deseja realmente excluir esse Funcionário? Se sim Digite 1");
