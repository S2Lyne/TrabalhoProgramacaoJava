...
public class Cliente extends Pessoa{
    ...
    public static void saveCliente() {
    	...
    	if(Global.servico.size() != 0) {
            ...
            Cliente c1 = new Cliente( 1, "Judah Mueller", 22, "(738) 250-7312", "ullamcorper.eu@protonmail.org", "01/04/1987");
            clien.add(c1);
            ...
            clien.add(c3);
            Cliente c4 = new Cliente( 4, "Maria Oliveira",56, "(31) 5555-1234","maria.oliveira@example.com","03/07/1988");
            clien.add(c4);
            Cliente c5 = new Cliente( 5,"Lucas Costa", 19,"(41) 2222-3333","lucas.costa@example.com", "18/12/2003");
            clien.add(c5);
            Cliente c6 = new Cliente( 6, "Isabella Almeida", 50, "(12) 9999-8888","isabella.almeida@example.com", "22/02/1973");
            clien.add(c6);
            Cliente c7 = new Cliente( 7, "Isabella Almeida", 50, "(12) 9999-8888","isabella.almeida@example.com", "22/02/1973");
            clien.add(c7);
  ...
  //metódo que update o Cliente
    ...
    public static void listarCliente() {
    	...
    	System.out.format( "\t Id\t " +"\t Nome\t " +"\t Idade\t "+ "\t Telefone \t"+ "\t E-mail \t"+ "\t Data de Nasc \t");
    	System.out.println(" ");
    ...
    public static void deletarCliente() {
        ...
        System.out.println("Informe o id do cliente a ser cancelado: ");
        idsc = scanner.nextInt();
